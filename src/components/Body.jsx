    ...
    <main>
      ...
      <div className="content">
        ...
        <p>
          ...
          multi-disciplinary clinic provides a balanced approach to a health
          lifestyle. Enhance your health and improve your performance with out
          treatments.
        </p>

        <p>
          We welcome you to come expolre all the benefits you'll enjoy as one of
          out balued guests. Our professional staff is committed to offering the
          best therapy in Mainland
        </p>
      </div>
